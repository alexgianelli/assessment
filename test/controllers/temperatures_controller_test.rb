...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { timestamp: @temperature.timestamp, value: @temperature.value } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { timestamp: @temperature.timestamp, value: @temperature.value } }
